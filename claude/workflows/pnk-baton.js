...
const setup = await agent(
  ...
  { agentType: 'pnk-baton-integrator', phase: 'Setup', label: 'setup:worktree', schema: SETUP, model: 'opus' },
)
...
const plan = await agent(
  ...
  { agentType: 'pnk-baton-planner', phase: 'Plan', schema: PLAN, model: 'opus' },
)
...
const baseline = await agent(
  ...
  { agentType: 'pnk-baton-integrator', phase: 'Baseline', label: 'baseline:base-failures', schema: BASELINE, model: 'opus' },
)
