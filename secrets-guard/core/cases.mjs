...
export const bashCases = [
  ...
  ["bare docker inspect", "docker inspect llama-cpp"],
  ["docker inspect -f without env", "docker inspect -f '{{.State.Status}}' llama-cpp"],
  ["docker inspect --format env (block)", "docker inspect -f '{{.Config.Env}}' llama-cpp"],
  ["docker inspect state+name (allow)", "docker inspect -f '{{.State.Status}} {{.Name}}' llama-cpp"],
