...
<constraints>
- YOU MUST NOT MODIFY TEST FILES. The tests define the contract. The baton reviewer verifies via `git diff` that no test file changed during your stage and REJECTS if one did. If a test appears wrong, STOP and report it back — do not fix it yourself.
